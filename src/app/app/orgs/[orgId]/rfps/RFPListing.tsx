...
import { deleteFolder } from '@/lib/apis/foldersApi';
...
export const RFPListing = ({
  ...
  // const handleRfpRenameSave = (id: string) => {
  //   setRfps((prev) =>
  //     prev.map((item) =>
        ...
        <DialogContent className='bg-white rounded-lg py-5 px-7 shadow-lg text-black sm:max-w-[500px]'>
          <DialogHeader>
            <DialogTitle className='text-lg font-bold'>
              Deleting {selectedRfp?.name}! Are you absolutely sure?
            </DialogTitle>
            <DialogDescription className='text-sm text-gray-600'>
              This action cannot be undone. This will permanently delete your
              RFP and all its content.
            </DialogDescription>
          </DialogHeader>
